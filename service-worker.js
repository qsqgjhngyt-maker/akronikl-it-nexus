const CACHE='akronikl-it-nexus-v0.1.6-alpha.1';
const RUNTIME_CACHE='akronikl-it-nexus-runtime-v0.1.6-alpha.1';
const CORE=["./", "./index.html", "./styles/app.css", "./core/app.js", "./core/glass-select.js", "./core/memory-lab.js", "./core/oop-lab.js", "./core/i18n.js", "./core/course-registry.js", "./core/storage.js", "./core/migrations/cpp-v7.js", "./sandbox/sandbox.js", "./sandbox/code-studio.js", "./sandbox/code-workspace.js", "./sandbox/provider-contract.js", "./sandbox/languages.js", "./sandbox/runtime-assets.js", "./sandbox/runtime-router.js", "./sandbox/diagnostics.js", "./sandbox/providers/browser-runtime.js", "./sandbox/providers/wasm-runtime.js", "./sandbox/providers/cloud-runtime.js", "./sandbox/workers/wasm-runtime-worker.js", "./effects/particles.js", "./akronikl/context.js", "./courses/catalog.json", "./courses/programming/languages.json", "./courses/cpp/manifest.json", "./courses/cpp/curriculum.json", "./courses/cpp/data/lessons.ru.json", "./courses/cpp/data/lessons.en.json", "./courses/cpp/data/practicums.ru.json", "./courses/cpp/data/projects.ru.json", "./locales/registry.json", "./locales/ru/ui.json", "./locales/en/ui.json", "./manifest.webmanifest", "./version.json", "./assets/icons/icon-192.png", "./assets/icons/icon-512.png", "./assets/icons/apple-touch-icon.png"];
