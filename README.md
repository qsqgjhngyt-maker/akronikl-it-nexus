...
**v0.1.3-alpha.1 / Benchmark 02 — Pointer & Memory Model.** Второй эталонный урок `Указатели, ссылки и адреса` полностью переработан на RU/EN: фундаментальная теория, lifetime/UB/RAII, интерактивная символическая модель памяти, Pointer Lab в Nexus Sandbox и Skill Graph. Первый benchmark и весь визуальный/UX baseline alpha.4.1 сохранены.
...
Текущий исполняемый релиз: [`RELEASE_v0.1.3-alpha.1.md`](RELEASE_v0.1.3-alpha.1.md). История изменений: [`CHANGELOG_v0.1.3-alpha.1.md`](CHANGELOG_v0.1.3-alpha.1.md).
