...
Текущий исполняемый релиз: [`RELEASE_v0.1.2-alpha.4.md`](RELEASE_v0.1.2-alpha.4.md). История изменений: [`CHANGELOG_v0.1.2-alpha.4.md`](CHANGELOG_v0.1.2-alpha.4.md).
