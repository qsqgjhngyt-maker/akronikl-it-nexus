...
Текущий исполняемый релиз: [`RELEASE_v0.1.2-alpha.3.md`](RELEASE_v0.1.2-alpha.2.md). История изменений: [`CHANGELOG_v0.1.2-alpha.3.md`](CHANGELOG_v0.1.2-alpha.2.md).
