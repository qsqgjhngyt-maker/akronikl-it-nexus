...
**v0.1.0-alpha.1 / Platform Shell.** The Foundation is preserved while the repository now contains an executable multilingual platform shell, C++ baseline package, safe legacy-progress bridge, and provider-independent Akronikl Context Model.

See [`RELEASE_v0.1.0-alpha.1.md`](RELEASE_v0.1.0-alpha.1.md).
