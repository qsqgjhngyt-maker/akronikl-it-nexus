...
const checks=[
  ...
  ['service worker caches selector module',sw.includes('./core/glass-select.js')&&/v0\.1\.(?:2-alpha\.4\.1|3-alpha\.1|4-alpha\.(?:1|2)|5-alpha\.(?:1|2)|6-alpha\.(?:1|2)|7-alpha\.(?:1|2\.1))/.test(sw)]
];
