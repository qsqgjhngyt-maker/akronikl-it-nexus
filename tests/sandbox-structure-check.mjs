...
for(const token of ['id="runCode"','id="testRuntime"','id="resetCode"','id="clearOutput"','id="editor"','id="stdin"','Nexus Runtime']) assert(app.includes(token),`Sandbox missing ${token}`);
